...
const HeaderNav = () => {
    ...
    return (
        <header className={cn(`relative w-full z-50 bg-white text-white transition-transform duration-300 shadow-md`)}>
            <div className=" border-b border-gray-200">
                <div className="px-4 mx-auto sm:px-6 lg:px-8">
                    <nav className="relative flex items-center justify-between h-16 lg:h-20">
                        ...
                        <button type="button" onClick={toggleExpanded} className="inline-flex p-2 ml-5 text-black transition-all duration-200 rounded-md lg:hidden focus:bg-gray-100 hover:bg-gray-100">
            ...
            <nav className={cn("py-4 bg-white lg:hidden border border-gray-300", !expanded && "hidden")}>
                <div className="px-4 mx-auto sm:px-6 lg:px-8">
                    <div className="flex flex-col space-y-2">
                        <a href="#" title="" className="py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600">
                            Features
                        </a>
                        <a href="#" title="" className="py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600">
                            Solutions
