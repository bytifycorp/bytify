...
const Footer = () => {
    return (
        <footer className="py-12 bg-white sm:pt-16 lg:pt-12 border-gray-300 border-t">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="mt-10 md:flex md:items-center md:justify-between">
                    ...
                    <p className="mt-8 text-base font-normal text-center text-gray-600 md:text-left md:mt-0 md:order-1 font-pj">© Copyright 2021, All Rights Reserved</p>
                </div>
            </div>
        </footer>
    );
